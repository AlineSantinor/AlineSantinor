...
![Banner](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,20,30&height=280&section=header&text=Aline%20Araújo&fontSize=55&fontAlign=50&fontAlignY=40&animation=fadeIn&fontColor=ffffff&desc=Desenvolvedora%20Web%20|%20React%20%20TypeScript&descAlign=50&descAlignY=60)
...
![Banner](https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=10,15,20&height=220&section=header&text=Aline%20Araújo&fontSize=50&animation=fadeIn&fontColor=ffffff)
# 👩‍💻 Aline Araújo
